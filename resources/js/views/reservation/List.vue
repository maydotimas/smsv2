  ...
  <div class="app-container">
    <div class="filter-container">
      <el-input
        ...
        :placeholder="$t('table.reservation_search')"
        style="width: 200px;"
        class="filter-item"
        @keyup.enter.native="getList"
      />
      <el-select v-model="listQuery.type" :placeholder="$t('table.reservation_status')" clearable style="width: 200px" class="filter-item">
        <el-option v-for="item in reservationStatus" :key="item" :label="item" :value="item" />
      </el-select>
      <el-button
        v-waves
        class="filter-item"
      ...
      <router-link to="/reservation/new">
        <el-button
...
export default {
  ...
  data() {
    return {
      ...
      reservationStatus: ['All', 'Active', 'Trashed'],
    };
  },
  created() {
    this.getList();
