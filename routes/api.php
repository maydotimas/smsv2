...
Route::namespace('Api')->group(function() {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        /*Students*/
        Route::apiResource('students', 'StudentController')->middleware('permission:manage student');
        Route::get('students', 'StudentController@index')->name('student.index')->middleware('permission:view student|manage student');
